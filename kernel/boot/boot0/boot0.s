...
|*
	...
	farjmpw	#0,1$		|* Desvia para o novo endereço
1$:
...
|*
pgversion:
	.isoz	"\nTROPIX boot0, Versao: 4.3.0, de 27.08.02\n"
...
1$:
	...
	bhs	8$		|* Retorna com o carry ligado
...
3$:
   ...
   |***	movb	...,r1		|* Setor
	...
	bcc	9$		|* Aproveita o CARRY clear para retornar
...
|*
	.org	start + 0x189	|* Para "putstr", ... terem endereços fixos
putstr:
	pushw	r4		|* Salva r4
	movw	r0,r4
1$:
...
|*	Verifica se tem as extensões da INT 13
	...
	bcs	4$			|* Desvia se retornou com o carry
...
6$:
   ...
   |***	movl	...,PBNO(fp)
	...
	bcs	9$			|* Se cilindro > 1023, encerra!
...
|*	movw	#linear_cb,r4		|* Endereço do bloco
	int	#0x13
	bcc	9$			|* Desvia se retornou sem o carry
