...
#ifdef	ATA_H
extern int	ata_command (ATA *, int, daddr_t, int, int, int);
extern int	ata_wait (ATA *, int);
...
extern int	geo_get_parttb_geo (const char *, HDINFO *, daddr_t, const char *);
extern int	geo_tst_geometry (const char *, const HDINFO *);
