...
|*
|******	Habilita a escrita de padrões no vídeo ******************
|*
|*	void	enable_idle_intr_pattern (void);
|*
	.text
	.global	_enable_idle_intr_pattern
_enable_idle_intr_pattern:
.if	IDLE_PATTERN || INTR_PATTERN
	movl	save_idle_videoaddr,r0

	disint

	movl	r0,_idle_videoaddr
	movl	#INTR_VIDEOADDR,_intr_videoaddr

	enint
.endif	IDLE_PATTERN || INTR_PATTERN
	rts

|*
|******	Desabilita a escrita de padrões no vídeo ****************
|*
|*	void	disable_idle_intr_pattern (void);
|*
	.text
	.global	_disable_idle_intr_pattern
_disable_idle_intr_pattern:
.if	IDLE_PATTERN || INTR_PATTERN
	movl	_idle_videoaddr,r0
	movl	r0,save_idle_videoaddr

	movl	#idle_intr_dummy_area,r0

	disint

	movl	r0,_idle_videoaddr
	movl	r0,_intr_videoaddr
...
.if	IDLE_PATTERN || INTR_PATTERN
|*
|******	Área de dados para enable/disable_idle_intr_pattern *****
|*
	.data
	.global	_intr_videoaddr
