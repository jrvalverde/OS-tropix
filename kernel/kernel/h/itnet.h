...
struct	tcp_ep
{
	...
	int	tp_reser2[15];	/* Para completar 512 bytes */
 ...
 ****************************************************************
 */
#define	I_IN_DAEMON	(('I' << 8) | 49)
#define	I_OUT_DAEMON	(('I' << 8) | 50)
#define	I_NFS_DAEMON	(('I' << 8) | 51)
#define	I_GET_ITSCB	(('I' << 8) | 52)
#define	I_PUT_ITSCB	(('I' << 8) | 53)
#define	I_GET_DNS	(('I' << 8) | 54)
#define	I_GET_ROUTE	(('I' << 8) | 55)
#define	I_GET_ETHER	(('I' << 8) | 56)
#define	I_GET_EXPORT	(('I' << 8) | 57)
#define	I_PUT_EXPORT	(('I' << 8) | 58)
#define	I_GET_NFS_MOUNT	(('I' << 8) | 59)
#define	I_GET_TCP_EP	(('I' << 8) | 60)
#define	I_GET_TCP_SORTQ	(('I' << 8) | 61)
#define	I_GET_TCP_INQ	(('I' << 8) | 62)
#define	I_GET_TCP_OUTQ	(('I' << 8) | 63)
#define	I_GET_TCP_INCOM	(('I' << 8) | 64)
#define	I_GET_TCP_LISQ	(('I' << 8) | 65)
#define	I_GET_RAW_INQ	(('I' << 8) | 66)
#define	I_GET_UDP_INQ	(('I' << 8) | 67)

#define	I_DNS_WAIT_REQ	(('I' << 8) | 71)
#define	I_DNS_PUT_INFO	(('I' << 8) | 72)
