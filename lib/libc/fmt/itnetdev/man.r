...
.fo 'Atualizado em 12.04.00'Versão 3.2.3'Pag. %'
...
.sp
Se a "ethernet" for institucional, estes valores são dados pelo gerente
da rede. Neste caso, as linhas podem (por exemplo) ter a forma
