...
.fo 'Atualizado em 19.08.02'Versão 4.3.0'Pag. %'
...
edboot [-2] [-v] [-d <dev>] [-p <pgm>] [<arquivo>]
.)l
...
Sem as opções "-d" nem "-p", são dados o dispositivo e programa "default"s contidos em "boot2".
