 ...
 ****************************************************************
 */
const char	pgversion[] =  "Versão: 4.6.0, de 16.06.04";
...
entry int		bar_hit, bar_inode, bar_kfile;
...
main (int argc, const char *argv[])
{
	...
	szhint.width = 540 + 2 * SHADOW; szhint.height = 255 + 2 * SHADOW;
