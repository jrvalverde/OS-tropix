 ...
 ****************************************************************
 */
entry const char	quote_vec[16] = "0123456789ABCDEF";
...
insert_attachments (char *attach_list, const char **text_file_nm)
{
	 ...
	 */
	if ((new_text_file_nm = alloc_and_copy (tmpnam (NOSTR))) == NOSTR)
